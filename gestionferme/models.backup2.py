...
class RationJournaliere(models.Model):
    ...
    aliment1 = models.ForeignKey(Aliment, related_name='aliment1_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    aliment2 = models.ForeignKey(Aliment, related_name='aliment2_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    aliment3 = models.ForeignKey(Aliment, related_name='aliment3_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    aliment4 = models.ForeignKey(Aliment, related_name='aliment4_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    aliment5 = models.ForeignKey(Aliment, related_name='aliment5_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    #date1 = date = models.DateField(default=datetime.today, verbose_name="Date Traitement1")
    produit1 = models.ForeignKey(Produit, related_name='produit1_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    produit2 = models.ForeignKey(Produit, related_name='produit2_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    produit3 = models.ForeignKey(Produit, related_name='produit3_rationJournaliere', on_delete=models.CASCADE, blank=True, null=True)
    ...
    # prixAliment5 = models.PositiveIntegerField(verbose_name="Prix Aliment 3", default=0)
