...
class Alevin(models.Model):
    ...
    # cout d'achat
    coutAchatTilapia = models.FloatField(verbose_name="Coût Achat Tilapia", default=0)
...
class Recolte(models.Model):
    cycleProduction = models.ForeignKey(CycleProduction, on_delete=models.CASCADE)
    # Tilapia
    dateVenteTilapia = models.DateField(verbose_name="Date de vente", default=datetime.today)
    ...
    # Clarias
    dateVenteClarias = models.DateField(verbose_name="Date de vente", default=datetime.today)
    ...
    # Autres
    dateVenteAutres  = models.DateField(verbose_name="Date de vente", default=datetime.today)
