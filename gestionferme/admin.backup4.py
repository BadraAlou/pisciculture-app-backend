...
class CycleProductionAdminClass(ImportExportModelAdmin, ModelAdmin):
    ...
    def rapport_financier_ferme_pdf(self, request, cycle_id):
        ...
        #totalAlevin = cycle.get_production_summary_optimized()
        #print(f'*** Super Yoh totalAlevin : {totalAlevin.total_par_structure_generale}')
        # print("Total alevins tilapia en bassin en ciment :", totalAlevin.data['tilapia']['bassin_en_ciment'])
        # print("Total alevins tilapia en étend en terre :", totalAlevin.data['claria']['etang_en_terre'])
        #print("Total supar :", totalAlevin.total_type('claria'))
        # totalAlevin.nb_bassin_ciment = totalAlevin.nombre_total_infrastructure('bassin_en_ciment')
        # totalAlevin.ct_bassin_ciment = totalAlevin.cout_total_infrastructure('bassin_en_ciment')
        # print("Nbre total bassin  :", totalAlevin.nb_bassin_ciment)
        # print("Cout total bassin :", totalAlevin.ct_bassin_ciment)
        totalAlevin.calculer_totaux()
        totalRation.calculer_totaux()
        # print("Tour 2: Nbre total bassin  :", totalAlevin.nb_bassin_ciment)
        # print("Tour 2: Cout total bassin :", totalAlevin.ct_bassin_ciment)
        
        # print("Yo ration:  aliment bassin :", totalRation.data['aliment1']['bassin_en_ciment'])
        # print("Yo ration:  produit bassin :", totalRation.data['produit1']['bassin_en_ciment'])
        # #print("Yo ration Prix:  aliment bassin :", totalRation.data['prix_aliment1']['bassin_en_ciment'])
        # print("Yo ration Prix:  aliment bassin :", totalRation.data['couts']['aliment1']['bassin_en_ciment'])
        # print("Yo ration Prix:  produit bassin :", totalRation.data['couts']['produit1']['bassin_en_ciment'])
        # print("Yo ration Prix 2:  produit bassin :", totalRation.data)
